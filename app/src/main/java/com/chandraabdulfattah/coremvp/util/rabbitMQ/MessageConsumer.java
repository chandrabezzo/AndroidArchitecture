...
public class MessageConsumer extends ConnectToRabbitMQ {
    ...
    public MessageConsumer(String server, String exchange, String exchangeType, String pattern,
                           String username, String password, String virtualHost) {
        super(server, exchange, exchangeType, username, password, virtualHost);
            ...
            public void run() {
                while(Running){
                    ...
                    try {
                        ...
                        AppLogger.i("mLastMessage ", mLastMessage.toString());
